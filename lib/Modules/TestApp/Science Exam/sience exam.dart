...
class QuizPage1 extends StatefulWidget {
  ...
  const QuizPage1({super.key, required this.request});
  @override
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text('OK' , style: TextStyle(fontSize: 20.0 , fontWeight: FontWeight.w600),),
          ),
        ],
      ),
    );
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Spacer(),
                    Icon(IconBroken.Paper , color: Colors.white,)
                  ],
                ),
              ),
              Padding(
